...
function addInputlcom(){
    ...
    if(document.getElementById("lcom-pwr-s").value >= "82"){
        lcomChances.push("فشل الصفقة");
       }
    if(document.getElementById("lcom-pwr-s").value >= "84"){
        lcomChances.push("فشل الصفقة");
       }
    if(document.getElementById("lcom-pwr-s").value >= "86"){
        lcomChances.push("فشل الصفقة");
       }
        ...
        if(bdef >= "18"){
          for(var n=0;n<6;n++){
            lcomChances.push("فشل الصفقة");
                                               ...
                                               /*      BUYER LAST SEASON TOURPHIES SITTINGS     */
    ...
    if(document.getElementById("lcom-buyer-lefl-s").value != "not"){
        var bstatueefl = document.getElementById("lcom-buyer-lefl-s").value;
    ...
    if(document.getElementById("lcom-buyer-licc-s").value != "not"){
        var bstatueicc = document.getElementById("lcom-buyer-licc-s").value;
        ...
        if(bstatueicc == "w"){
           lcomChances.push("نجاح الصفقة");
                                               ...
                                               /*      SELLER LAST SEASON TOURPHIES SITTINGS     */


    /*      LAST UCL SITTINGS     */

    if(document.getElementById("lcom-seller-lucl-s").value != "not"){
        var sstatueucl = document.getElementById("lcom-seller-lucl-s").value;
    ...
    if(document.getElementById("lcom-seller-luel-s").value != "not"){
        var sstatueuel = document.getElementById("lcom-seller-luel-s").value;
    ...
    if(document.getElementById("lcom-seller-lfa-s").value != "not"){
        var sstatuefa = document.getElementById("lcom-seller-lfa-s").value;
    ...
    if(document.getElementById("lcom-seller-lefl-s").value != "not"){
        var sstatueefl = document.getElementById("lcom-seller-lefl-s").value;
    ...
    if(document.getElementById("lcom-seller-licc-s").value != "not"){
        var sstatueicc = document.getElementById("lcom-seller-licc-s").value;
...
function addInputgcom(){
    ...
    if(document.getElementById("gcom-buyer-licc-s").value != "not"){
        var bstatueicc = document.getElementById("gcom-buyer-licc-s").value;
    ...
    if(document.getElementById("gcom-seller-lucl-s").value != "not"){
        var sstatueucl = document.getElementById("gcom-seller-lucl-s").value;
    ...
    if(document.getElementById("gcom-seller-luel-s").value != "not"){
        var sstatueuel = document.getElementById("gcom-seller-luel-s").value;
    ...
    if(document.getElementById("gcom-seller-licc-s").value != "not"){
        var sstatueicc = document.getElementById("gcom-seller-licc-s").value;
